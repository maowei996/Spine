      ...
      _export("Html5", Html5 = class Html5 {
        ...
        static LoadImage(file, sp, _onComplete) {
          ...
          image.onload = function () {
            ...
            _onComplete && _onComplete(texture);
          };
        ...
        static readLocalFile(cbComplect) {
          Html5.HtmlFileInput(function (file) {
            (_crd && FileTools === void 0 ? (_reportPossibleCrUseOfFileTools({
              error: Error()
            }), FileTools) : FileTools).getInstance().readLocalFile(file, 1, function (data) {
              cbComplect && cbComplect(data);
            });
          });
        }

        static readTexture2d(cbComplect) {
          Html5.HtmlFileInput(function (file) {
            Html5.LoadImage(file, null, function (texture) {
              cbComplect && cbComplect(file.name, texture);
            });
          });
        }
...
//# sourceMappingURL=6b240a7fe0492ef735f0d16f3b546b1e75ef5cf6.js.map