System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EventTarget, Sprite, assetManager, Texture2D, sp, FileTools, Html5, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, eventTarget, ccclass, property, Machine;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec3 = property(sp.Skeleton), _dec(_class = (_class2 = class Machine extends Component {
        ...
        start() {
          eventTarget.on('machine', this.onEvent, this);
        }
        ...
        onDisable() {
          eventTarget.off('machine', this.onEvent, this);
        }
...
//# sourceMappingURL=02d9acf6c527a997a0cdbb755e838f989d5fb1a2.js.map