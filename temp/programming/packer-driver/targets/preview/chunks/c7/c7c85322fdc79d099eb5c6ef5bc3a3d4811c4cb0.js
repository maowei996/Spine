      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec(_class = (_class2 = class Machine extends Component {
        ...
        onTest() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            ...
            (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
              error: Error()
            }), Html5) : Html5).LoadImage(file, this.sp, null); //FileTools.getInstance().readLocalFile(file,1,function( data : any ){
...
//# sourceMappingURL=c7c85322fdc79d099eb5c6ef5bc3a3d4811c4cb0.js.map