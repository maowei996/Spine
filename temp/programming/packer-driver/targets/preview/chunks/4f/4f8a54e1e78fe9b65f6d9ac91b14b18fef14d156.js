System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, ScrollView, instantiate, ItemOption, EventType, EventData, EventManager, Html5, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, ViewType, OptionScrollview;
      ...
      _export("OptionScrollview", OptionScrollview = (_dec = ccclass('OptionScrollview'), _dec2 = property(Prefab), _dec3 = property(Number), _dec(_class = (_class2 = class OptionScrollview extends Component {
            ...
            option.clickFunc = function (ani) {
              if (this.viewType != ViewType.Event_view) {
                ...
                (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
                  error: Error()
                }), Html5) : Html5).setClipboardData(ani);
              }
            }.bind(this);
          }
        }
        ...
        notify() {
          ...
          if (this.viewType == ViewType.Spine_view) {
            ...
            (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
              error: Error()
            }), Html5) : Html5).setClipboardData(this._curChooseName);
...
//# sourceMappingURL=4f8a54e1e78fe9b65f6d9ac91b14b18fef14d156.js.map