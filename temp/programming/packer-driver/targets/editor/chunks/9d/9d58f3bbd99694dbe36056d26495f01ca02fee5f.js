      ...
      _export("FileOper", FileOper = (_dec = ccclass('FileOper'), _dec(_class = class FileOper extends Component {
        ...
        onPng() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            error: Error()
          }), Html5) : Html5).readTexture2d('.png', function (name, url, texture) {
        ...
        onJsonData() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            error: Error()
          }), Html5) : Html5).readLocalFile('.json', 1, function (name, data) {
            self._jsonData = data;
            self.checkComplect();
          });
        }
        ...
        onAtlasData() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            error: Error()
          }), Html5) : Html5).readLocalFile('.atlas', 1, function (name, data) {
        ...
        onSkelData() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            error: Error()
          }), Html5) : Html5).readLocalFile('.skel', 3, function (name, data, url) {
...
//# sourceMappingURL=9d58f3bbd99694dbe36056d26495f01ca02fee5f.js.map