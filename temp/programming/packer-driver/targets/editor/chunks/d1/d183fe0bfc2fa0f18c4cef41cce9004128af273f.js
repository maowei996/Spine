System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EventTarget, Sprite, assetManager, Texture2D, sp, FileTools, Html5, EventManager, EventType, Eventparam, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, evey, evetp, eventTarget, ccclass, property, Machine;
  ...
  function _reportPossibleCrUseOfEventparam(extras) {
    _reporterNs.report("Eventparam", "./Define", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Eventparam = _unresolved_5.Eventparam;
    }],
    execute: function () {
      _crd = true;
      ...
      evey = _crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
        error: Error()
      }), EventType) : EventType;
      evetp = _crd && Eventparam === void 0 ? (_reportPossibleCrUseOfEventparam({
        error: Error()
...
//# sourceMappingURL=d183fe0bfc2fa0f18c4cef41cce9004128af273f.js.map