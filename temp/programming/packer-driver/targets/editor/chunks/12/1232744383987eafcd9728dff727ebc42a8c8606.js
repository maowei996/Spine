    ...
    execute: function () {
      ...
      _export("FileOper", FileOper = (_dec = ccclass('FileOper'), _dec(_class = class FileOper extends Component {
        ...
        addSkeletonData() {
          ...
          data.skins = [];
          data.animations = [];
          let _skeletonJson = asset._skeletonJson;
          let animations = _skeletonJson.animations || Array;
          let skins = _skeletonJson.skins || Array;

          for (const key in animations) {
            data.animations.push(key);
          } // for (const iterator of skins) {
          //   data.animations.push(iterator);
          // }
...
//# sourceMappingURL=1232744383987eafcd9728dff727ebc42a8c8606.js.map