System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Sprite, sp, Label, EventManager, EventType, SkeletManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, Machine;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec3 = property(sp.Skeleton), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec(_class = (_class2 = class Machine extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "slotsLaebl", _descriptor8, this);
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "slotsLaebl", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=a2f8e353e5e35a83f842b4a423ceb849e3c9e1a7.js.map