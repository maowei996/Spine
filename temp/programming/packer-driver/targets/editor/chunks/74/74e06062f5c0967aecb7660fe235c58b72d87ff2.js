System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Texture2D, ImageAsset, Html5, _crd, mime, createObjectURL, SelectFile;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Html5", Html5 = class Html5 {
        ...
        static LoadImage(file, _onComplete) {
          ...
          image.onload = function () {
            ...
            console.log(image);
            let imas = new ImageAsset();
            imas._nativeAsset = image;
            let texture = new Texture2D(); // texture.mipmaps = image;
...
//# sourceMappingURL=74e06062f5c0967aecb7660fe235c58b72d87ff2.js.map