    ...
    execute: function () {
      ...
      _export("Drag", Drag = (_dec = ccclass('Drag'), _dec(_class = class Drag extends Component {
        ...
        onTouchStartCallback(touch, event) {
          ...
          var myNodePos = this.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(location.x, location.y, 1)); // this.node.position = myNodePos;
        }
...
//# sourceMappingURL=d6fd2de1c4a3ea635a9de25702d5ba180cac2d15.js.map