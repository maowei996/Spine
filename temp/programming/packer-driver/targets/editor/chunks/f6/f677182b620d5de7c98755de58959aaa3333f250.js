    ...
    execute: function () {
      ...
      _export("Drag", Drag = (_dec = ccclass('Drag'), _dec(_class = class Drag extends Component {
        ...
        onTouchStartCallback(touch, event) {
          ...
          let myNodePos = this.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(location.x, location.y, 1));
...
//# sourceMappingURL=f677182b620d5de7c98755de58959aaa3333f250.js.map