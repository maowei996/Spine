    ...
    execute: function () {
      ...
      _export("Drag", Drag = (_dec = ccclass('Drag'), _dec(_class = class Drag extends Component {
        ...
        onTouchStartCallback(touch, event) {
          ...
          let uipos = this.cameraUI.screenToWorld(new Vec3(location.x, location.y, 1));
          let myNodePos = this.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(touchWPos.x, touchWPos.y, 1)); //this.node.position = myNodePos;
...
//# sourceMappingURL=b9a10268edb546e4e863135285d6c8ba27463451.js.map