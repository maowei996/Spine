    ...
    execute: function () {
      ...
      _export("Html5", Html5 = class Html5 {
        static HtmlFileInput(_cb) {
          ...
          inputel.setAttribute('accept', '.png');
          ...
          inputel.onchange = function (event) {
            ...
            if (files && files.length > 0) {
              ...
              _cb && _cb(filedata); // document.removeChild(inputel);
            }
        ...
        static readLocalFile(cbComplect, readType = 1) {
...
//# sourceMappingURL=51429ea1f11b290a1e72b8d81df258b1df1884e7.js.map