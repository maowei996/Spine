    ...
    execute: function () {
      ...
      _export("FileOper", FileOper = (_dec = ccclass('FileOper'), _dec(_class = class FileOper extends Component {
        ...
        addSkeletonData() {
          ...
          data.skins = [];
          data.animations = [];
          var _skeletonJson = asset._skeletonJson;
          var animations = _skeletonJson.animations || Array;
          var skins = _skeletonJson.skins || Array;
...
//# sourceMappingURL=d054e569256cf7541be2ebdce53931688c07be66.js.map