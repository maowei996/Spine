      ...
      _export("Html5", Html5 = class Html5 {
        static HtmlFileInput(_fileType, _cb) {
          ...
          if (!inputel) {
            ...
            inputel.style.position = 'absolute'; // inputel.setAttribute('left', '-999px');
          ...
          inputel.onclick = function () {// console.log('111');
          };
...
//# sourceMappingURL=430c5b90add3db5ad8c4ee73aea1aaebeef10911.js.map