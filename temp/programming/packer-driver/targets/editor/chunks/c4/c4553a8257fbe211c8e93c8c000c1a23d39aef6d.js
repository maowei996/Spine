    ...
    execute: function () {
      ...
      _export("Menu", Menu = (_dec = ccclass('Menu'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class Menu extends Component {
        ...
        onSkeleron() {
          ...
          if (!active) {
            let skeletons = (_crd && SkeletManager === void 0 ? (_reportPossibleCrUseOfSkeletManager({
              error: Error()
            ...
            let option = this.skeletonPanel.getComponent(_crd && OptionScrollview === void 0 ? (_reportPossibleCrUseOfOptionScrollview({
              error: Error()
        ...
        onEvent() {
          ...
          if (!active) {
            ...
            let option = this.eventPanel.getComponent(_crd && OptionScrollview === void 0 ? (_reportPossibleCrUseOfOptionScrollview({
              error: Error()
            }), OptionScrollview) : OptionScrollview);
...
//# sourceMappingURL=c4553a8257fbe211c8e93c8c000c1a23d39aef6d.js.map