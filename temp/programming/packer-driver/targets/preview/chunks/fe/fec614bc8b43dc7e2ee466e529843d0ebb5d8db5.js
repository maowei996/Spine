      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec(_class = (_class2 = class Machine extends Component {
        ...
        onTest() {
          ...
          (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
            ...
            (_crd && Html5 === void 0 ? (_reportPossibleCrUseOfHtml({
              error: Error()
            }), Html5) : Html5).LoadImage(file, spr, null); //FileTools.getInstance().readLocalFile(file,1,function( data : any ){
...
//# sourceMappingURL=fec614bc8b43dc7e2ee466e529843d0ebb5d8db5.js.map