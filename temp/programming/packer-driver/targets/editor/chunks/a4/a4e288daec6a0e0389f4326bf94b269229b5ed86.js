System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Sprite, assetManager, Texture2D, sp, Label, EventManager, EventType, SkeletManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, Machine;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'assetManager', 'Texture2D', 'SpriteFrame', 'ImageAsset', 'sp', 'Label']);
      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec3 = property(sp.Skeleton), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = class Machine extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEvent(data) {
          ...
          if (_eventType == (_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
            ...
            skeleton.animation = data.param.defanimation; //console.log('onEvent.skeleton:',skeleton);
...
//# sourceMappingURL=a4e288daec6a0e0389f4326bf94b269229b5ed86.js.map