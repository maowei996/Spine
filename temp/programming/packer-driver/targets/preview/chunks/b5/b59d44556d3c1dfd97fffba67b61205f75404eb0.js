    ...
    execute: function () {
      ...
      _export("Drag", Drag = (_dec = ccclass('Drag'), _dec(_class = class Drag extends Component {
        ...
        onTouchStartCallback(touch, event) {
          ...
          var myNodePos = this.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(location.x, location.y, 1));
...
//# sourceMappingURL=b59d44556d3c1dfd97fffba67b61205f75404eb0.js.map