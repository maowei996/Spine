      ...
      _export("Html5", Html5 = class Html5 {
        ...
        static LoadImage(file, sp, _onComplete) {
          ...
          image.onload = function () {
            ...
            console.log(image);
            var strurl = image.currentSrc;
            var img = new Image();
            img.src = strurl; //let imas = new ImageAsset(image);
            //imas._nativeAsset = image;

            var imas = new ImageAsset(img);
            ...
            sf.texture = texture;
            sp.spriteFrame = sf; // sp.width = this.width;
...
//# sourceMappingURL=d5169d14374b5d9be350f2521f94375077e67626.js.map