System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Machine", Machine = (_dec = ccclass('Machine'), _dec2 = property(Sprite), _dec3 = property(sp.Skeleton), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec(_class = (_class2 = class Machine extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "timeScale", _descriptor8, this);

          _initializerDefineProperty(this, "spineName", _descriptor9, this);
        ...
        onEvent(data) {
          ...
          if (_eventType == (_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
            ...
            error: Error()
          }), EventType) : EventType).OPENOROFF_DEBUG) {
            var _skeleton = this.skeleton;

            if (_skeleton) {
              _skeleton.debugBones = true;
              _skeleton.debugSlots = true;
              _skeleton.debugMesh = true;
            }
          } else if (_eventType == (_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
            error: Error()
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "timeScale", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "spineName", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=f746b48ff9841c1b10a17eb28a4d31c23194a64e.js.map