System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Texture2D, ImageAsset, sys, FileTools, Html5, _crd, mime, createObjectURL, SelectFile;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['Texture2D', 'ImageAsset', 'SpriteFrame', 'sys']);
      ...
      _export("Html5", Html5 = class Html5 {
        ...
        static setClipboardData(str) {
          ...
          if (sys.platform == 'MOBILE_BROWSER' || sys.platform == 'DESKTOP_BROWSER') {
            ...
            if (result) {//window.alert('已成功复制到剪贴板！');
            } else {//window.alert('复制失败！');
            }
        ...
        static readLocalFile(fileType, readType = 1, cbComplect) {
...
//# sourceMappingURL=73bf6c85896a54efb627987841ec71f5b219275b.js.map